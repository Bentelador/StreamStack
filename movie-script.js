...
async function loadMovies() {
        ...
        document.getElementById('main-content').innerHTML = `
        <iframe  class="main-watch" id="main-watch" src="https://vidsrc-embed.ru/embed/movie/${ids}" sandbox = "allow-forms allow-pointer-lock allow-same-origin allow-scripts allow-top-navigation" allow="fullscreen; encrypted-media;"></iframe>
